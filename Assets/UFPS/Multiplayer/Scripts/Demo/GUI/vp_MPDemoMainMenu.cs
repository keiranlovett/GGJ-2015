...
public class vp_MPDemoMainMenu : Photon.MonoBehaviour
{
	...
	protected string m_PlayerName = "Player";
	...
	{
		GUI.depth = 1;
		m_TargetSplashColor.a = ((PhotonNetwork.connectionStateDetailed == PeerState.Joined) ? 0.0f : 1.0f);
	...
	protected virtual void DrawTextField(string text, Vector2 position, Vector2 scale, GUIStyle textStyle, Color textColor, Color bgColor, Texture texture)
	{
		...
		m_PlayerName = GUI.TextField(m_LabelRect, m_PlayerName, 16, LeftStyle);
		m_PlayerName = m_PlayerName.Replace("\n", "");
		m_PlayerName = m_PlayerName.Replace(".", "");
		m_PlayerName = m_PlayerName.Replace(",", "");
		m_PlayerName = m_PlayerName.Replace("|", "");
