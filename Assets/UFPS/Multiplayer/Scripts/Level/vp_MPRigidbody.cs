...
public class vp_MPRigidbody : Photon.MonoBehaviour
{
	...
	protected virtual void FixedUpdate()
	{
		...
		if (vp_Gameplay.isMultiplayer && !vp_Gameplay.isMaster && vp_MPLocalPlayer.Instance != null)
		{
			...
			{
				vp_MPLocalPlayer.Instance.Player.Move.Send(vp_MathUtility.NaNSafeVector3(transform.TransformPoint(vp_MPLocalPlayer.Instance.Controller.m_PositionOnPlatform) -
