...
public class vp_MPMaster : Photon.MonoBehaviour
{
	...
	public void StartGame()
	{
		...
		photonView.RPC("UnFreeze", PhotonTargets.All);
	...
	public void StopGame()
	{
		...
		photonView.RPC("Freeze", PhotonTargets.All);
	...
	public void RequestInitialSpawnInfo(PhotonPlayer player, int id, string name)
	{
		...
		// spawn
		photonView.RPC("InitialSpawnInfo", PhotonTargets.All, id, player, placement.Position, placement.Rotation, playerTypeName, teamNumber);
	...
	/// </summary>
	[RPC]
	protected virtual void Freeze(PhotonMessageInfo info)
	{
	...
	/// </summary>
	[RPC]
	protected virtual void UnFreeze(PhotonMessageInfo info)
	{
	...
	/// <summary>
	/// stops the game clock if a level is loaded
	/// </summary>
	protected virtual void OnLevelWasLoaded()
	{

		// TODO: maybe this should just run StartGame if you're master client
