...
public class GatewayGamesRagdollHelper : MonoBehaviour {
	...
	void setKinematic(bool newValue)
	{
		...
		foreach (Transform child in children)	
		{
			...
			{
				child.GetComponent<Rigidbody>().isKinematic = newValue;
					child.GetComponent<Rigidbody>().isKinematic = newValue;
				child.GetComponent<Collider>().isTrigger = newValue;
				child.GetComponent<Collider>().enabled = !newValue;
