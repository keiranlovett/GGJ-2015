...
[ CustomEditor( typeof( GatewayGamesSearchCoverBacover) ) ]
public class GatewayGamesSearchCoverBacoverEditor : Editor 
{
	
	private GatewayGamesSearchCoverBacover sc;
	
	void Awake()
	{
		sc = (GatewayGamesSearchCoverBacover)target;
	}
	...
	public override void OnInspectorGUI()
	{
		...
		sc.lm = LayerMaskField("LayerMask for Cover", sc.lm, true);
